...
python -m script.server \
--example libero \
--ckpt-path examples/libero/result/0906-pointdropknn01-basetcpfinger-cls4-rolechain-current-progress-sam-custom0902_newsplit-ep10-rel/checkpoints/step_30000.pt \
--execute-chunk-len 10 \
--progress-window 2 \
--progress-threshold 0.9 \
--locator-scale 2.0 \
