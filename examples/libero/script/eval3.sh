...
--example libero \
--ckpt-path examples/libero/result/0906-pointdropknn005-basetcpfinger-cls4-full-current-progress-sam-custom0902_newsplit-ep10-rel/checkpoints/step_30000.pt \
