...
class InferenceServer:
    """WebSocket layer for InferenceModel."""
    ...
    async def serve(self) -> None:
        ...
        cs.print("WebSocket messages should be JSON model inputs; replies are transformed model outputs.")
    ...
    async def handle_connection(self, websocket: websockets.ServerConnection) -> None:
        ...
        async for message in websocket:
            ...
            try:
                ...
                response = {"outputs": self.inference.infer(input_data)}
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Serve GraphVLA model.infer over WebSocket.")
