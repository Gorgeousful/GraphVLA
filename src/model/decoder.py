"""Independent-query cross-attention decoder adapted from Open-d4rt."""
...
class IndependentQueryDecoder(nn.Module):
    ...
    def __init__(self, hidden_dim: int, num_layers: int, num_heads: int, mlp_ratio: float, dropout: float = 0.1) -> None:
        super().__init__()
