...
class Sam3StreamInference(Sam3VideoBase):
    ...
    def add_prompt(
        ...
        if boxes_xywh is not None:
            if box_prompt_mode not in {"visual", "geometric"}:
                raise ValueError(f"Unsupported box_prompt_mode={box_prompt_mode!r}. Use 'visual' or 'geometric'.")
