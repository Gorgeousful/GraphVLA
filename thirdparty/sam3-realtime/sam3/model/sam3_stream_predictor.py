...
class Sam3StreamPredictor:
    ...
    Exposed request types:
      ...
      - {"type": "add_prompt", "session_id": str, "frame_index": int, "text": Optional[str],
         ...
         "box_prompt_mode": Optional["visual"|"geometric"]}
    ...
    Hotstart removal is disabled by default to keep early prompt-created
    tracklets from being removed when they do not match detector outputs.
    """
    ...
    def __init__(
        ...
        self.model = (
            build_sam3_stream_model(
                ...
                disable_hotstart=disable_hotstart,
                device=device,
                compile=compile,
            )
            .to(device=device)
    ...
    def handle_request(self, request):
        ...
        if request_type == "start_session":
            ...
            return self.add_prompt(
                ...
                box_prompt_mode=request.get("box_prompt_mode", "visual"),
            )
