...
def build_sam3_stream_model(
    ...
    hotstart_delay = 0 if disable_hotstart else 15
    hotstart_unmatch_thresh = 0 if disable_hotstart else 8
    hotstart_dup_thresh = 0 if disable_hotstart else 8
    recondition_every_nth_frame = 0 if disable_hotstart else 16
